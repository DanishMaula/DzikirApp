...
class PagiPetangDzikirActivity : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnDzikirPagi: ImageButton = findViewById(R.id.img_button_dzikir_pagi)
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.img_button_dzikir_pagi -> startActivity(Intent(this, DzikirPagiActivity::class.java))
